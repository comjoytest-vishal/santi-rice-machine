...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2026 at 10:01 AM
...
(13, 'baam', '2026-03-10 06:28:04'),
(15, 'BAAAM', '2026-03-10 06:42:09');
...
(7, '2026-03-11', 'zakir', '123@456', 'funny', 400.00, 'vishal', 200.00, 200.00, 'sumit', 100.00, '2026-03-07 07:12:15');
...
(9, 'zakir', '123@456', '2026-03-07 07:09:15'),
(10, 'j12', 'kpoudski', '2026-03-07 08:47:22'),
(11, 'kamal', 'kamal1', '2026-03-10 05:15:30');
...
(6, 'kumar', '2026-03-06 12:03:07'),
(7, 'plastic', '2026-03-07 07:12:43');

-- --------------------------------------------------------

--
-- Table structure for table `sub_consumable_main`
--

CREATE TABLE `sub_consumable_main` (
  `id` int(11) NOT NULL,
  ...
  `opening` bigint(20) DEFAULT NULL,
  `purchase` bigint(20) DEFAULT NULL,
  `use_enter` bigint(20) DEFAULT NULL,
  `dealer` varchar(255) DEFAULT NULL,
  `staff` varchar(255) DEFAULT NULL,
  `closing_entry` bigint(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `sub_consumable_main`
--

INSERT INTO `sub_consumable_main` (`id`, `machine_code`, `machine_description`, `parent_name`, `sub_name`, `date`, `opening`, `purchase`, `use_enter`, `dealer`, `staff`, `closing_entry`) VALUES
(1, 'main', 'main', 'ram', 'naam', '2026-03-19', 1111111, 1111111, 111111109, 'AAAAAAAAAAAAAA', 'AAAAAAA', 11111111),
(2, 'wqe', 'wqe', 'ram', 'sam', '2026-03-15', 11111, 11111110, 1111111111111, 'AAAAAAAAAAAAA', 'QQQQQQQQQQ', 111111),
(3, 'zakir', '123@456', 'plastic', 'bag', '2026-03-21', 300, 899, 599, 'kumar', 'kunal', 100);
...
(9, 6, 'asdffffffffffsaa', '2026-03-06 12:03:18'),
(12, 5, 'zara', '2026-03-07 07:14:01');
...
(4, 'p1', 'power machine', 'sdfsf', 'dsada', 'sadasd', '2026-02-27', NULL),
(6, 'ram', 'saam', 'nothing', 'right', 'left', '2026-02-27', NULL),
(7, 'jay', 'kumar', 'lol', 'nooooop', 'why', '2026-02-27', NULL),
(8, 'try', 'try', 'try', 'not', 'try', '2026-02-27', '2026-03-10 11:57:33'),
(9, 'j1', 'joydip', 'hoogly', 'office', 'jaggu', '2026-02-27', NULL),
(10, 'main', 'main', 'no work', 'nothing', 'my', '2026-03-04', '2026-03-04 14:29:13'),
(11, 'zakir', '123@456', 'nothing', 'nooo', 'vishal', '2026-03-07', '2026-03-07 12:40:01');
...
--
-- Indexes for table `sub_consumable_main`
--
ALTER TABLE `sub_consumable_main`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `sub_consumable_main`
--
ALTER TABLE `sub_consumable_main`
